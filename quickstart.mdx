...
<AccordionGroup>
  <Accordion icon="workflow" title="Create a workflow">
    Workflows are how you build AI-powered automations in Cogfy. Navigate to the Workflows route and create a new workflow, then add nodes to define how it should respond to incoming messages.
