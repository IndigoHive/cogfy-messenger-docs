...
## Workflow Types
Workflow types refer to the different triggers to a workflow. You should have a workflow for each trigger typ
Currently Cogfy supports two types of workflows: Message Received and Data Exchange.
...
They include executing an [HTTP Request](), running [JavaScript Code](), using an [Assistant]() chat completion and sending different types of messages.

#### Logic Nodes
Conditionals and path routing. Currently Cogfy supprots one logic node: the [If Node]()
