...
The Message Received node is a trigger that provides complete information about message, contact and conversation associated to it.
...
<ResponseField name='conversation' type='object'>
  ...
  <Expandable title="properties">
    ...
    <ResponseField name='isFirstMessageFromContact' type='boolean | undefined'>
      Flag that indicates if the message receives is the first message **from the user**.
